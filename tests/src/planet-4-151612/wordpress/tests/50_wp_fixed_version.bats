...
@test "WP_VERSION 4.9.7 - shutdown existing containers" {
  docker-compose -f "${compose_file}" down -v
}

@test "WP_VERSION 4.9.7 - docker compose start $IMAGE_TAG" {
